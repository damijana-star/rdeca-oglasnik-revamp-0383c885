...
const AdvertisingBenefits = () => {
  return <section id="benefits" className="py-16 bg-gray-50 font-extrabold text-6xl">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 font-extrabold text-6xl">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Zakaj oglaševati z nami</h2>
