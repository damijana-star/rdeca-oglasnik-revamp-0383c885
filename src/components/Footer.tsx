  ...
  return <footer className="bg-gray-100 pt-12 pb-6">
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
          {clientLogos.map((logo, index) => <div key={index} className="bg-white rounded-md p-4 flex items-center justify-center h-20 shadow-sm transition-all duration-300 hover:shadow-md hover:scale-105" style={{
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        <div id="about" className="fade-in" style={{
        animationDelay: '0.1s'
      }}>
          <h3 className="mb-4">
            <img src="/lovable-uploads/7bb6fbc9-f86e-41ec-8b55-658095999864.png" alt="NANOSKI OGLASNIK" className="h-8 transition-transform duration-300 hover:scale-105" />
          </h3>
          <p className="text-gray-600 mb-4">
            Oglasnik za NOTRANJSKO-KRAŠKO, OBALNO-KRAŠKO in GORIŠKO regijo.
          </p>
          <div className="flex space-x-4">
            <a href="https://www.facebook.com/profile.php?id=61575021988033" target="_blank" rel="noopener noreferrer" className="text-dark-red hover:text-white hover:bg-dark-red rounded-full p-2 transition-all duration-300 hover:scale-110">
              <Facebook size={20} />
            </a>
            ...
            <a href="#" className="text-dark-red hover:text-white hover:bg-dark-red rounded-full p-2 transition-all duration-300 hover:scale-110">
              <Mail size={20} className="link to email: info@nanoski-oglasnik.eu" />
            </a>
          </div>
        </div>
        ...
        <div id="contact" className="fade-in" style={{
        animationDelay: '0.3s'
      }}>
